...
export default function Legal_Notice() {
    return (
        <main className="w-[375px] mx-auto min-h-screen bg-saone-cream">
            <Header />
            <main className="w-[375px] mx-auto min-h-screen flex flex-col gap-4 bg-saone-cream">
            <div className="flex flex-col items-center">
                <img src="../realfrontend/assets/Logo-principal.png" alt="Logo" className="w-[130px] h-[130px] object-cover mb-[40px] mt-[30px]"/>
            </div>
            <div className="text-[13px] text-saone-green font-montserrat">
