...
export default function Mentions_Legales() {
  return (
    <body class="w-[375px] mx-auto min-h-screen flex flex-col gap-4 bg-saone-cream">
        ...
        <div class="text-[13px] text-saone-green font-montserrat">
            <h2 class="font-caveat text-[18px] text-saone-green uppercase">1. éditeur de l'application</h2>
        ...
        <div class="text-[13px] text-saone-green font-montserrat">
            <h2 class="font-caveat text-[18px] text-saone-green uppercase">2. hébergement</h2>
        ...
        <div class="text-[13px] text-saone-green font-montserrat">
            <h2 class="font-caveat text-[18px] text-saone-green uppercase">3. propriété intellectuelle</h2>
        ...
        <div class="text-[13px] text-saone-green font-montserrat">
            <h2 class="font-caveat text-[18px] text-saone-green uppercase">4. données personnelles</h2>
        ...
        <div class="text-[13px] text-saone-green font-montserrat">
            <h2 class="font-caveat text-[18px] text-saone-green uppercase">5. responsabilité</h2>
        ...
        <div class="text-[13px] text-saone-green font-montserrat">
            <h2 class="font-caveat text-[18px] text-saone-green uppercase">6. droit applicable</h2>
