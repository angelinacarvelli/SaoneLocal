        ...
        <main className="p-2 flex flex-col items-center">
          ...
          <div className="bg-saone-green text-saone-cream rounded-3xl p-6 mb-4 shadow-lg w-[90%]">
            ...
            <div class="flex flex-row gap-2 justify-center">
              <img src="../../../public/assets//products/Boulangerie/boulangerie-pain-campagne.jpg" alt="pain-campagne" class="w-[105px] h-[105px] object-cover rounded-3xl"/>
              <img src="../../../public/assets/products/Fruits-légumes/legumes-patates.jpg" alt="patates" class="w-[105px] h-[105px] object-cover rounded-3xl"/>
              <img src="../../../public/assets/products/Vins/vins-mercurey-blanc.jpg" alt="mercurey-blanc" class="w-[105px] h-[105px] object-cover rounded-3xl"/>
            </div>
