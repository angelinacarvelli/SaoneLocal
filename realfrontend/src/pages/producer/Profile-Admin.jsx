                ...
                <div id="produit" class="hidden mt-4">
                    ...
                    <section class="mt-[18px] bg-saone-green rounded-[16px] px-2 text-saone-cream flex flex-col gap-2 items-center">
                        <div class="flex flex-row gap-2">
                            <img src="/assets/users/saonelocal-karim-producteur.jpg" class="w-[90px] h-[90px] rounded-[18px] object-cover"/>
                            <img src="/assets/users/saonelocal-michel-producteur.jpg" class="w-[90px] h-[90px] rounded-[18px] object-cover"/>
                            <img src="/assets/users/saonelocal-isabelle-producteur.jpg" class="w-[90px] h-[90px] rounded-[18px] object-cover"/>
                        </div>
