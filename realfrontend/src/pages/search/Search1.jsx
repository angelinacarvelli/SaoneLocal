        ...
        <main class="w-full max-w-md min-h-screen relative shadow-2xl bg-saone-cream font-montserrat">
            ...
            <div class="flex flex-col items-center">
                ...
                <section class="w-[90%] mt-[22px] bg-saone-green rounded-[16px] p-2">
                    <img src="../../../public/assets/search/le-saviez-vous-appellations.jpg" class="w-full h-[105px] rounded-[14px] object-cover"/>
                ...
                <section class="w-[90%] mt-[12px] bg-saone-green rounded-[16px] p-2">
                    <img src="../../../public/assets/search/le-saviez-vous-climat.jpg" class="w-full h-[105px] rounded-[14px] object-cover"/>
