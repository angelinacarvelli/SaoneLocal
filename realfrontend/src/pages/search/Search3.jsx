    ...
    <main class="bg-saone-cream font-montserrat">
        <div class="max-w-[375px] mx-auto px-4 pb-24">
            ...
            <section class="mt-[22px] bg-saone-green rounded-[16px] p-2">
                <img src="../../../public/assets/le-saviez-vous-miel.jpg" class="w-full h-[105px] rounded-[14px] object-cover"/>
            ...
            <section class="mt-[12px] bg-saone-green rounded-[16px] p-2">
                <img src="../../../public/assets/le-saviez-vous-fromage-epoisses.jpg" class="w-full h-[105px] rounded-[14px] object-cover"/>
